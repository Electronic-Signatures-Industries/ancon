...
func RegisterTxRoutes(clientCtx client.Context, rtr *mux.Router) {
	...
	r.HandleFunc("/txs", authrest.DecodeTxRequestHandlerFn(clientCtx)).Methods("POST")
	r.HandleFunc("/txs/encode", authrest.DecodeTxRequestHandlerFn(clientCtx)).Methods("POST")
